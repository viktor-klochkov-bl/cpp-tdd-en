...
//
// - **What it is:**
//   - A filter against over-engineering.
// - **Why it matters:**
...
//   - A key foundation for testability.
...
// %%
non_humble_order_processor::demonstrate_non_humble_order_processor();
...
// %%
humble_order_processor::test_order_service();
...
// %%
humble_order_processor::demonstrate_humble_object();
